...
import kotlinx.android.synthetic.main.activity_workoutday3.*
import java.text.SimpleDateFormat
import java.util.*

class workoutday3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_workoutday3)
        ...
        btn2.setOnClickListener {
            val intent = Intent(this, tabata::class.java)
            startActivity(intent)
        }
